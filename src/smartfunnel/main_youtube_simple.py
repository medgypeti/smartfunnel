...
#         # Initialize youtube_dict with proper structure
#         youtube_dict = {
#             'values': [],
#             'life_events': [],
#             'challenges': [],
...
#         if hasattr(crew_result, 'raw'):
#             try:
#                 parsed_data = json.loads(crew_result.raw)
#                 if isinstance(parsed_data, list):
#                     # Handle list of objects
#                     for item in parsed_data:
#                         if isinstance(item, dict):
#                             # Determine the type of object and add to appropriate list
#                             if all(k in item for k in ['name', 'origin', 'impact_today']):
#                                 youtube_dict['values'].append(item)
#                             elif all(k in item for k in ['name', 'description']):
#                                 youtube_dict['life_events'].append(item)
#                             elif 'learnings' in item:
#                                 youtube_dict['challenges'].append(item)
#                             elif 'description' in item:
#                                 youtube_dict['achievements'].append(item)
#                 elif isinstance(parsed_data, dict):
#                     youtube_dict = parsed_data
